...
var derivativesPairsSchema = new Schema({
    ...
    "autoOrderExecute"   : { type: Number, default: 1 },
...
module.exports = mongoose.model('DerivativesPairs', derivativesPairsSchema, 'DerivativesPairs')